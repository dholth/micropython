...
SRC_USERMOD_C += $(OPUS_MOD_DIR)/opusmodule.c
...
CFLAGS_USERMOD += $(LIBOPUS_CFLAGS) $(LIBOGG_CFLAGS) $(LIBOPUSFILE_CFLAGS)
LDFLAGS_USERMOD += $(LIBOPUS_LDFLAGS) $(LIBOGG_LDFLAGS) $(LIBOPUSFILE_LDFLAGS)
